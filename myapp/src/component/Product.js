      ...
      <div style={{display:'block'}}>
        ...
        <div style={{display:'flex', height:'50px'}}>
         ...
         <Button  variant='contained' color='primary' style={{display:'inline', height:'40px', width:'100px' , marginLeft: '10px'}}
            onClick={deleteData}>Delete
         </Button>
         </div>
      </div>
    </Box>    
 
    <Product_02 ref={childRef} onUpdated={()=>setpage(1-page)}/>                        
    <Product_03 ref={documentDetailsRef} onUpdated={()=>setpage(1-page)}/>
 <Box sx={{  width: '100%' }}>
      <DataGrid
        pagination
        rows={data}
